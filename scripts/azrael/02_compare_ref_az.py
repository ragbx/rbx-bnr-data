...
az = la dernière extraction de ref
...
new_ref_az_ok = new_ref_az_ok[['name', 'path', 'size', 'last_content_modification_date',
                  'last_metadata_modification_date', 'ref_checksum_md5', 'ref_uuid']]
new_ref_az_ok.columns = ['name', 'path', 'size', 'last_content_modification_date',
                  'last_metadata_modification_date', 'checksum_md5', 'uuid']
new_ref_az_ok.to_csv(join("results", "ref", "tmp", f"new_ref_az_ok_{new_ref_date}.csv.gz"), index=False)

print(len(new_ref_az_ko_left))
new_ref_az_ko_left = new_ref_az_ko_left[['name', 'path', 'size', 'last_content_modification_date',
                  'last_metadata_modification_date']]
new_ref_az_ko_left.to_csv(join("results", "ref", "tmp", f"new_ref_az_ko_left_{new_ref_date}.csv.gz"), index=False)
...
new_ref_az_ko_right.columns = ['name', 'path', 'size', 'last_content_modification_date',
                  'last_metadata_modification_date', 'checksum_md5', 'uuid']
new_ref_az_ko_right.to_csv(join("results", "ref", "tmp", f"new_ref_az_ko_right_{new_ref_date}.csv.gz"), index=False)

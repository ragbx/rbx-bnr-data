...
indexation_df.to_csv(join("analyses", "indexation", "indexation_genreform_20251212.csv"), index=False)
indexation_df['nb'] = 1
indexation_df_gr = indexation_df.pivot_table(
    ...
    margins=True,
    margins_name = 'Total')
indexation_df_gr.reset_index().to_excel(join("analyses", "indexation", "indexation_genreform_20251212_grp.xlsx"), index=False)
